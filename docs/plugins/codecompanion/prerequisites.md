...
```sh
pnpm add -g pi-acp        # or: npm i -g pi-acp   (requires >= 0.0.33)
```
...
Use pi 0.80.4 or newer: pi-acp 0.0.33 completes ACP turns on the `agent_settled`
event introduced there.
